...
import '../App.css'
import Search from './../images/news.jpg'
...
render() {
  ...
  return (
    ...
    <Form inline className="Search-header">
      ...
      <select className="form-control " style={{width:"15%"}} id="orderby" onChange={this.mQueryOrderByChange} onClick={()=> this.doOrderBy(mQuery)}>
...
<nav aria-label="Page navigation example">
    <ul className="pagination justify-content-center">
    {
        ...
        // </li>
        <Button color="secondary" onClick={()=>this.buttonPress(this.props.job.prev)}> Previous </Button>
      }
      {
        ...
        // </li>
        <Button color="success" onClick={()=>this.buttonPress(this.props.job.next)}> Next </Button>
      }
    </ul>
</nav>
</div>
