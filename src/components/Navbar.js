...
{!this.state.isLogin&&(
    ...
    <ul className="navbar-nav">
        <li className="nav-item active ">
         <Link to='/findjobs' className="nav-link text-success font-sub-nav">Find Jobs</Link>
      </li>
      <li className="nav-item">
      <Link to='/blog' className="nav-link  text-success font-sub-nav" >News</Link>
     </li>
      <li className="nav-item">
      <Link to='/about' className="nav-link  text-success font-sub-nav" >About</Link>
      </li>
      <li>
      <Link to='/contact' className="nav-link  text-success font-sub-nav" >Contact</Link>
      </li>
      <li>
      <Link to='/detail/:id' className="nav-link  text-success font-sub-nav" >Detail</Link>
      </li>
    </ul>
      <div className="my-2 my-lg-0">
      <Link to='/login'><button className="btn btn-outline-success btn-sm font-login" type="button" value="Login">Login</button></Link>
      <Link to='/signup'><input className="btn btn-dark btn-secondary font-login" type="button" value="Sign Up"></input></Link>
